...
abstract class UpdateMessageDigestInputStream extends InputStream {
	 ...
	 * @param messageDigest the message digest to update 要更新的消息摘要
	 * @throws IOException when propagated from {@link #read()} 当调用read()传输时会抛出此异常
	 */
